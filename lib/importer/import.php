				...
				if( class_exists( 'WP_Importer' ) && class_exists( 'SQ_Import' ) ) {
					...
					switch( $_POST['import'] ) {
						...
						case 'page':
							...
							if ( $_POST && array_key_exists('options', $_POST) && $_POST['options'] ) {
								$this->import_options( $_POST['page'] );
							}
		...
		<div id="kleo-wrapper" class="kleo-import wrap">
			...
			<form action="<?php echo admin_url( 'themes.php?page=' . $this->slug . '&import' );?>" method="post">
				...
				<table class="form-table">
					...
					<tr class="row-content hide hidden">
						...
						<td>
							<select name="content">
								...
								<option value="vc-grid">Visual Composer Grids</option>
					...
					<tr class="row-homepage hide hidden">
						...
						<td>
							<select name="page">
								...
								<option value="home-creative" data-attach="yes" data-options="yes">Home Creative</option>
								<option value="home-shop" data-attach="yes">Home Shop</option>
								<option value="home-shop-v2" data-attach="yes" data-options="yes">Home Shop V2</option>
					...
					<tr class="row-options hide hidden">
						<th scope="row">Options</th>
						<td>
							<fieldset>
								<label for="options"><input type="checkbox" value="1" id="options" name="options">Import Theme options</label>
								<p class="description">Change theme settings and customizer values to match the demo.</p>
							</fieldset>
						</td>
					</tr>
