...
if ( sq_option('woo_custom_cat_size') == true ) {

    add_filter( 'subcategory_archive_thumbnail_size', 'set_sq_woo_cat' );

    function set_sq_woo_cat() {
        return 'sq_woo_cat';
    }

    add_image_size( 'sq_woo_cat',
        sq_option( 'woo_cat_width', '400' ),
        sq_option( 'woo_cat_height', '300' ),
        true
    );
    add_filter('woocommerce_get_image_size_sq_woo_cat', 'sq_woo_cat_image_size');

    function sq_woo_cat_image_size() {
       return array(
           'width' => sq_option( 'woo_cat_width', '400' ),
           'height' => sq_option( 'woo_cat_height', '300' ),
           'crop'   => 1
        );
    }
