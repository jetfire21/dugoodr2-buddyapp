...
function kleo_load_dynamic_css() {
    ...
    $extra_string = sq_option( 'stime', '' );
    $version = KLEO_THEME_VERSION . '.' . $extra_string;

    wp_register_style( 'kleo-dynamic', trailingslashit( Kleo::get_config( 'custom_style_url' ) ) . Kleo::get_config( 'custom_style_name' ), array(), $version, 'all' );
